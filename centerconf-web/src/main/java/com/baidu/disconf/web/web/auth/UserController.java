...
import com.baidu.dsp.common.vo.ConfJsonObject;
...
public class UserController extends BaseController {
    ...
    @ResponseBody
    public ConfJsonObject get() {

        VisitorVo visitorVo = userMgr.getCurVisitor();
        if (visitorVo != null) {

        	 ConfJsonObject ret = new ConfJsonObject();
             ret.setSuccess("true");
...
//            return buildGlobalError("syserror.inner", ErrorCode.GLOBAL_ERROR);
    ...
    @ResponseBody
    public ConfJsonObject signin(@Valid SigninForm signin, HttpServletRequest request) {
